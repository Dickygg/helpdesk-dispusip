...
@section('title', 'Daftar Status Tiket')
@section('page-title', 'Daftar Status Tiket')
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#statusbaruModal" class="btn btn-primary btn-sm float-right">Tambah Daftar Status Tiket</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="gap-1">
                                    <a href="{{ route('status.edit', $r->id) }}" class="btn btn-primary btn-sm">
...
<div class="modal fade" id="statusbaruModal" tabindex="-1"
    role="dialog" aria-labelledby="statusbaruModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"
                    id="statusbaruModalLabel">Tambah Data Status</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="textarea" class="form-control form-control-user @error('description') is-invalid @enderror" value="{{ @old('description') }}" id="description" name="description"
                            placeholder="Masukan Deskripsi Status">
                        @error('description')
                        <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
